...
#define MS_WHITE_CLUSTER_ID      0xFC10
...
class ZigbeeSensor : public ZigbeeDevice {
    public:
        ...
        void onLevelChange(void (*callback)(uint8_t, uint8_t, uint8_t, uint16_t));
    ...
    private:
        ...
        void (*_on_level_change)(uint8_t, uint8_t, uint8_t, uint16_t);
};
